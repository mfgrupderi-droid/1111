...
const RenkAnalizi = () => {
    ...
    // OrderManagement'daki getDetailUniqueValues fonksiyonunu kullan
    ...
    // Siparişteki benzersiz cinsleri al
    const availableCinsler = selectedOrder && selectedOrder.items
