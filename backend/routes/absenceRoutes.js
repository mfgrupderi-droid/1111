...
// BELİRLİ BİR ÇALIŞANIN DEVAMSIZLIKLARINI GETİR
// GET /api/absences/:employeeId
...
// YENİ DEVAMSIZLIK KAYDI OLUŞTUR
// POST /api/absences
...
router.delete('/', async (req, res) => {
    ...
    try {
        // Tarihin sadece gün kısmını eşleştirmek için başlangıç ve bitişini buluyoruz
