...
router.post('/', async (req, res) => {
  try {
    const { firstName, lastName, phone, email, photo, identityNumber, department, position, hireDate } = req.body;
...
router.put('/:id', async (req, res) => {
  try {
    ...
    const employee = await Employee.findByIdAndUpdate(
      req.params.id,
      { firstName, lastName, phone, email, photo, identityNumber, department, position, hireDate, updatedAt: Date.now() },
