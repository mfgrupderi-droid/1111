...
const createTransporter = () => {
    return nodemailer.createTransport({
      ...
      auth: {
        ...
        pass: "ivlb msnu udht rdeq" // ivlb msnu udht rdeq
...
// HTML email template - Excel tarzı tablo
const createEmailHTML = (sevkiyat, sirket) => {
  // Tablo header'ları oluştur
