...
router.post('/', async (req, res) => {
  try {
    ...
    // Ödemeyi populate ederek döndür
...
router.get('/bakiye/:fasoncuId', async (req, res) => {
  try {
    ...
    // Toplam işçilik tutarını hesapla
...
// Fasoncuya göre ödemeleri getir
