...
const Odemeler = () => {
    ...
    const fetchPayments = async () => {
        ...
        setError(null);
        try {
            const response = await axios.get(API_URL, { params: { year } });
    ...
    const fetchWeeklyData = async () => {
        ...
        setError(null);
        try {
            const response = await axios.get(`${API_URL}/weekly`, { params: { year } });
...
const handleAmountChange = (id, field, value) => {
    ...
    const createCarryOverPayment = async (fullName, amount, currentDate) => {
        try {
            ...
            const allPaymentsResponse = await axios.get(API_URL, { params: { year } });
