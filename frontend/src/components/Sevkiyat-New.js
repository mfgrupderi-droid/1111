...
function Sevkiyat() {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            const sevkiyatResponse = await axios.get(API_BASE_URL_SEVKIYAT);
            ...
            const sevkiyatlarWithSirketAdi = sevkiyatData.map(sevkiyat => {
                ...
                return {
                    ...
                    sirketId: sevkiyat.sirketId // Keep original sirketId for update/add ops
                };
            });
