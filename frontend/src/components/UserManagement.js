...
const UserManagement = () => {
    ...
    // Gerçek uygulamada bu rol, Context API veya JWT token'dan gelecektir.
    // Şimdilik "kurucu" rolünü simüle ediyoruz.
    const currentUserRole = 'kurucu'; // 'yönetici', 'kullanici' veya 'kurucu' olabilir.
    ...
    // Ancak daha iyi bir yaklaşım, yetkileri doğrudan backend'den almaktır.
    // Şimdilik sadece frontend tarafında bu şekilde yönetebiliriz.
